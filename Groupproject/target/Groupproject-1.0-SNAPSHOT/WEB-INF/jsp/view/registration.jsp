...
<center><br>
        ...
        <div id="logincard" class="card text-dark bg-light mb-3 text-center" style="max-width: 35rem;" >
            <div class="card-header text-dark bg-light mb-3"><h2><fmt:message key="language.registration"/></h2></div>
                <div class="card-body text-dark bg-light mb-3">
                        <form:form name="form" method="POST" enctype="multipart/form-data" modelAttribute="ticketUser">
                            <form:label path="username"></form:label><br/>
                            <form:input type="text" path="username"  placeholder="Username" class="d-grid gap-2 col-8 mx-auto outline-secondary" style="height: 3rem;"  /><br/><br/>  
                            <form:label path="password"></form:label><br/>
                            <form:input type="text" path="password" placeholder="Password" class="d-grid gap-2 col-8 mx-auto outline-secondary" style="height: 3rem;"/><br/><br/>
                            <form:input type="hidden" path="roles" value="ROLE_USER" />
                            <form:label path="fullname"></form:label><br/>
                            <form:input type="text" path="fullname" placeholder="Your Name" class="d-grid gap-2 col-8 mx-auto outline-secondary" style="height: 3rem;"/><br/><br/>
                            <form:label path="phone"></form:label><br/>
                            <form:input type="number" path="phone" placeholder="Phone Number" class="d-grid gap-2 col-8 mx-auto outline-secondary" style="height: 3rem;"/><br/><br/>
                            <form:label path="address"></form:label><br/>
                            <form:input type="text" path="address" placeholder="Address" class="d-grid gap-2 col-8 mx-auto outline-secondary" style="height: 3rem;"/><br/><br/>
                            
                            
                            <button type="submit" class="btn btn-primary d-grid gap-2 col-8 mx-auto " style="height: 3rem;"><h5><fmt:message key="language.registration"/></h5></button><br/>
